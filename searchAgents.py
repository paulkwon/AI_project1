...
class CornersProblem(search.SearchProblem):
    ...
    def __init__(self, startingGameState):
        ...
        self.bCornersVisited = (False, False, False, False)
        self.startState = (self.startingPosition, self.bCornersVisited)
    ...
    def getSuccessors(self, state):
        ...
        for action in [Directions.NORTH, Directions.SOUTH, Directions.EAST, Directions.WEST]:
            ...
            if not self.walls[nextx][nexty]:
                ...
                bCornersVisited = state[1]      
                if (nextx,nexty) == self.corners[0]: 
                    bCornersVisited = (True,) + bCornersVisited[1:4]
                if (nextx,nexty) == self.corners[1]: 
                    bCornersVisited = bCornersVisited[0:1] + (True,) + bCornersVisited[2:4]
                if (nextx,nexty) == self.corners[2]: 
                    bCornersVisited = bCornersVisited[0:2] + (True,) + bCornersVisited[3:4]
                if (nextx,nexty) == self.corners[3]: 
                    bCornersVisited = bCornersVisited[0:3] + (True,)
                
                nextState = ( (nextx, nexty), bCornersVisited ) 
